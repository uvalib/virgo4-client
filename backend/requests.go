...
func (svc *ServiceContext) CreateOpenURLRequest(c *gin.Context) {
	...
	if illErr != nil {
		...
		c.String(illErr.StatusCode, "There was an error during your request. You may need to <a href=\"https://www.library.virginia.edu/services/ils/ill/\">set up an Illiad account</a> first.")
		return
	}
