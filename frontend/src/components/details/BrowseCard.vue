<template>
   <div class="browse-card" :class="{current: props.current, list: props.mode!='gallery'}" :aria-current="props.current.toString()" :id="`browse-${props.data.id}`">
      <template v-if="props.mode=='gallery'">
         ...
         <BookmarkButton :pool="props.pool" :hit="data" @clicked="bookmarkClicked(props.data.id)"/>
      </template>
      <template v-else>
         <div class="list details">
            ...
            <BookmarkButton :pool="props.pool" :hit="props.data" @clicked="bookmarkClicked(props.data.id)"/>
         </div>
      </template>
   </div>
</template>
