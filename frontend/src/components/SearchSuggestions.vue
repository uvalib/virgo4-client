   ...
   <div v-if="suggestor.open" >
      ...
      <div class="wrapper">
         ...
         <div v-if="suggestor.didYouMean && suggestor.requestedFeatures.includes('didyoumean')" class="section">
            ...
            <SuggestorDebug v-if="userStore.isAdmin && preferences.aiDebug && suggestor.suggestionMetadata?.didyoumean" :metadata="suggestor.suggestionMetadata.didyoumean" />
         </div>
         ...
         <div v-if="suggestor.suggestions.some( s => s.type == 'author')" class="section">
            ...
            <SuggestorDebug v-if="userStore.isAdmin && preferences.aiDebug && suggestor.suggestionMetadata?.authors" :metadata="suggestor.suggestionMetadata.authors" />
         </div>
         ...
         <div v-if="suggestor.suggestions.some( s => s.type == 'book')" class="section">
            ...
            <SuggestorDebug v-if="userStore.isAdmin && preferences.aiDebug && suggestor.suggestionMetadata?.books" :metadata="suggestor.suggestionMetadata.books" />
         </div>
         ...
         <div v-if="suggestor.suggestions.some( s => s.type == 'image')" class="section">
            ...
            <SuggestorDebug v-if="userStore.isAdmin && preferences.aiDebug && suggestor.suggestionMetadata?.images" :metadata="suggestor.suggestionMetadata.images" />
         </div>
...
import SuggestorDebug from './SuggestorDebug.vue'
