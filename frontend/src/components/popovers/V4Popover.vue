<template>
   <v-popover placement="top-end" class="v4-popover" trigger="manual" :autoHide="true" :open="isOpen" @hide="hide" @apply-show="opened">
   ...
   methods: {
      ...
      setFocus(id) {
         ...
         if (ele ) {
            ...
            console.error(`focus target ${id} not found`)
            setTimeout( () => {
               ...
               if (ele ) {
                  ...
                  console.error(`focus target ${id} not found on retry`)
                  ...
                  if (ele) {
                     ...
                     console.error("Couldn't set focus on target popover element "+id+" or fallback "+fallback)
                  }
               }
            }, 250)
         }
      ...
      opened() {
         setTimeout(()=>{
            ...
            console.log(`${this.id} popover opened. Set focus to ${tgt}`)
            this.setFocus(tgt)
            this.$emit('opened')
         }, 260)
      },
